...
const featuredAlumni = [
  { name: "Arjun Nair", dept: "CSE", year: 2020, role: "Sr. Software Engineer, Google", achievement: "Led development of Google Pay India features.", imageUrl: "https://placehold.co/150x150/1A1A2E/A78BFA?text=AN" },
  { name: "Priya Menon", dept: "IT", year: 2019, role: "Product Manager, Microsoft", achievement: "Launched Azure AI services for the Indian market.", imageUrl: "https://placehold.co/150x150/1A1A2E/A78BFA?text=PM" },
  { name: "Rahul Krishnan", dept: "ECE", year: 2021, role: "Founder, TechVenture", achievement: "Built an IoT platform serving 10M+ devices.", imageUrl: "https://placehold.co/150x150/1A1A2E/A78BFA?text=RK" },
];
  ...
  return (
    <>
      ...
      >
        ...
        <header className="fixed top-0 left-0 right-0 bg-black/30 backdrop-blur-md z-30">
  <nav className="container mx-auto px-6 py-4 flex justify-between items-center">
    ...
    <div className="flex items-center space-x-3">
      <img 
        src={Logo} 
        alt="CSMIT Logo" 
        className="h-10 w-auto rounded-md"  // adjust h-10 to h-12 if you want it bigger
      />
      <span className="text-2xl font-bold text-white">CSMIT</span>
    </div>
    ...
    <div className="hidden md:flex space-x-8 items-center">
      ...
      <a href="#alumni" className="text-gray-300 hover:text-white transition">Alumni</a>
      <a href="#members" className="text-gray-300 hover:text-white transition">Members</a>
      <a href="#events" className="text-gray-300 hover:text-white transition">Events</a>
    </div>

    {/* 🔹 Right side: Login/Signup */}
    <div className="flex items-center space-x-4">
      <button onClick={() => setIsLoginModalOpen(true)} className="px-4 py-2 text-sm border border-purple-400 text-purple-400 rounded-md hover:bg-purple-400 hover:text-black transition">Login</button>
      <button onClick={() => setIsSignUpModalOpen(true)} className="px-4 py-2 text-sm bg-purple-500 text-white rounded-md hover:bg-purple-600 transition">Sign Up</button>
    </div>
  </nav>
</header>
            ...
            <section id="events" className="py-20 px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                    <div className="bg-gray-900/70 backdrop-blur-md border border-gray-700 p-8 rounded-lg">
                        ...
                        <button className="px-5 py-2 border border-purple-400 text-purple-400 text-sm font-semibold rounded-lg hover:bg-purple-400 hover:text-black transition">View Events</button>
                    </div>
                    <div className="bg-gray-900/70 backdrop-blur-md border border-gray-700 p-8 rounded-lg">
        ...
        <footer className="py-16 px-6 sm:px-12 bg-black/50 backdrop-blur-md border-t border-purple-500/20 text-gray-400">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8 max-w-7xl mx-auto text-center md:text-left">
                ...
                <div>
                    ...
                    <p className="text-sm">Email: <a href="mailto:csmit@mit.edu" className="hover:text-purple-400 transition">csmit@mit.edu</a></p>
