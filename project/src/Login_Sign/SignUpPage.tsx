...
const SignUpPage = ({ isOpen, onClose, onSwitchToLogin }: { isOpen: boolean, onClose: () => void, onSwitchToLogin: () => void }) => {
  ...
  return (
    ...
    >
      <div 
        className="relative w-full max-w-md bg-gray-900/80 border border-purple-500/30 rounded-2xl p-8 shadow-2xl shadow-purple-500/20 overflow-y-auto max-h-[90vh]"
