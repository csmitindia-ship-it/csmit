...
const LoginPage = ({ isOpen, onClose, onSwitchToSignUp, onSwitchToForgotPassword }: { isOpen: boolean, onClose: () => void, onSwitchToSignUp: () => void, onSwitchToForgotPassword: () => void }) => {
  ...
  return (
    ...
    >
      <div 
        className="relative w-full max-w-md bg-gray-900/80 border border-purple-500/30 rounded-2xl p-8 shadow-2xl shadow-purple-500/20"
      ...
      >
        ...
        <form className="space-y-6">
          <div>
            ...
            <select className="w-full px-4 py-3 bg-gray-800/60 border border-gray-700 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all duration-300">
